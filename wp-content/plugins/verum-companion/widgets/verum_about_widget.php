...
class About_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        parent::__construct(
            'about_widget',
            esc_html__('About', 'verum'),
            array('description' => esc_html__('Verum_about_widget', 'verum')) // Args
        );
    ...
    public function widget($args, $instance)
    {
        ...
        if ($instance['verum_about_image']) {
            echo wp_get_attachment_image($instance['verum_about_image'], 'verum_about_img');

        }

        echo '<p class="pt-3"> <em>' . esc_html($instance['verum_about_description']) . '</em></p>';

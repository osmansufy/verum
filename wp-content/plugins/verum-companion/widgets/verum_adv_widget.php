...
class Verumadvertisement_Widget extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        $adv_img = wp_get_attachment_image_src($instance['verum_adv_img'], 'medium');
        echo '<a target="_blank" href="' . esc_url($instance['verum_adv_url']) . '  "><img class="img-fluid" src="' . esc_url($adv_img[0]) . '" alt=""/></a>';
